...
public class NecromancyPeriapt extends AphoreaTrinketItem {
    public NecromancyPeriapt() {
    ...
    public TrinketBuff[] getBuffs(InventoryItem item) {
        return new TrinketBuff[]{(TrinketBuff)BuffRegistry.getBuff("necromancyperiaptbuff")};
    }
}
