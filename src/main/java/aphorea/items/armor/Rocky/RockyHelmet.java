...
public class RockyHelmet extends AphoreaSetHelmetArmorItem {
    public RockyHelmet() {
        super(7, DamageTypeRegistry.MELEE, 250, Rarity.COMMON, "rockyhelmet", "rockychestplate", "rockyboots", "rockysetbonusbuff");
