...
abstract public class AphoreaTrinketItem extends TrinketItem {
    public boolean healingEnchantments = false;

    public AphoreaTrinketItem(Rarity rarity, int enchantCost) {
    ...
    public Set<Integer> getValidEnchantmentIDs(InventoryItem item) {
        ...
        if(healingEnchantments) {
            enchantments.addAll(AphoreaEnchantments.healingEquipmentEnchantments);
        }
        return enchantments;
    }
}
