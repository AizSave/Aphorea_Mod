package aphorea.other.buffclass;
...
abstract public class PeriaptActivableBuff extends TrinketBuff implements ActiveBuffAbility {

    public String activeBuff;

    public PeriaptActivableBuff(String activeBuff) {
