...
public class AphoreaArea {
    ...
    public void showAreaParticles(Mob mob, AphoreaAreaList areaList, Color forcedColor, float rangeModifier) {
            ...
            if(color != null) {
                ...
                if(position > 0) {
                    ...
                    if(antArea.color == null) {
                        antArea.showAreaParticles(mob, areaList, color, rangeModifier);
                    }
                }
            }
        }
