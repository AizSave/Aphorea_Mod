...
public class AphoreaCustomChargeLevel<T extends AphoreaChargeAttackToolItem> {

    public int timeToCharge;
    public float damageModifier;
    public Color particleColors;

    public AphoreaCustomChargeLevel(int timeToCharge, float damageModifier, Color particleColors) {
        this.timeToCharge = timeToCharge;
        this.damageModifier = damageModifier;
        this.particleColors = particleColors;
    }

    public void setupAttackItem(AphoreaCustomChargeAttackHandler<T> attackHandler, InventoryItem attackItem) {
        attackItem.getGndData().setFloat("chargeDamageMultiplier", this.damageModifier);
    }

    public void onReachedLevel(AphoreaCustomChargeAttackHandler<T> attackHandler) {
    ...
    public void updateAtLevel(AphoreaCustomChargeAttackHandler<T> attackHandler, InventoryItem showItem) {
