...
public class AphoreaCustomGreatswordChargeAttackHandler<T extends AphoreaGreatswordCustomChargeToolItem> extends MouseAngleAttackHandler {
    ...
    public AphoreaCustomGreatswordChargeLevel<T>[] chargeLevels;
    ...
    public AphoreaCustomGreatswordChargeAttackHandler(PlayerMob player, PlayerInventorySlot slot, InventoryItem item, T toolItem, int seed, int startX, int startY, AphoreaCustomGreatswordChargeLevel<T>[] chargeLevels) {
    ...
    public void updateCurrentChargeLevel() {
        while(true) {
            if (this.currentChargeLevel < this.chargeLevels.length - 1) {
                ...
                AphoreaCustomGreatswordChargeLevel<T> nextLevel = this.chargeLevels[this.currentChargeLevel + 1];
    ...
    public void onEndAttack(boolean bySelf) {
        ...
        if (this.currentChargeLevel >= 0 && !this.endedByInteract) {
            ...
            AphoreaCustomGreatswordChargeLevel<T> currentLevel = this.chargeLevels[this.currentChargeLevel];
