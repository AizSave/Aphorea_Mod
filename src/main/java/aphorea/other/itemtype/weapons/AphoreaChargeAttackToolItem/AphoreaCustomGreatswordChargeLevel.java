...
public class AphoreaCustomGreatswordChargeLevel<T extends AphoreaGreatswordCustomChargeToolItem> {

    public int timeToCharge;
    public float damageModifier;
    public Color particleColors;

    public AphoreaCustomGreatswordChargeLevel(int timeToCharge, float damageModifier, Color particleColors) {
        this.timeToCharge = timeToCharge;
        this.damageModifier = damageModifier;
        this.particleColors = particleColors;
    }

    public void setupAttackItem(AphoreaCustomGreatswordChargeAttackHandler<T> attackHandler, InventoryItem attackItem) {
        attackItem.getGndData().setFloat("chargeDamageMultiplier", this.damageModifier);
    }

    public void onReachedLevel(AphoreaCustomGreatswordChargeAttackHandler<T> attackHandler) {
    ...
    public void updateAtLevel(AphoreaCustomGreatswordChargeAttackHandler<T> attackHandler, InventoryItem showItem) {
