...
public class AphoreaCustomChargeAttackHandler<T extends AphoreaChargeAttackToolItem> extends MouseAngleAttackHandler {
    ...
    public AphoreaCustomChargeLevel<T>[] chargeLevels;
    ...
    public AphoreaCustomChargeAttackHandler(PlayerMob player, PlayerInventorySlot slot, InventoryItem item, T toolItem, int seed, int startX, int startY, AphoreaCustomChargeLevel<T>[] chargeLevels) {
    ...
    public void onEndAttack(boolean bySelf) {
        ...
        if (this.currentChargeLevel >= 0 && !this.endedByInteract) {
            ...
            AphoreaCustomChargeLevel<T> currentLevel = this.chargeLevels[this.currentChargeLevel];
