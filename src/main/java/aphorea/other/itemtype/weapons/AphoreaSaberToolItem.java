...
abstract public class AphoreaSaberToolItem extends AphoreaChargeAttackToolItem implements ItemInteractAction {

    public IntUpgradeValue dashRange;
    boolean isCharging;

    public AphoreaSaberToolItem(int enchantCost, AphoreaCustomChargeLevel... chargeLevels) {
    ...
    public static AphoreaCustomChargeLevel[] getChargeLevels() {
        return new AphoreaCustomChargeLevel[]{
                new AphoreaCustomChargeLevel<>(80, 1.0F, new Color(255, 255, 255)),
                new AphoreaCustomChargeLevel<>(90, 1.25F, new Color(255, 255, 0)),
                new AphoreaCustomChargeLevel<>(100, 1.5F, new Color(255, 128, 0)),
                new AphoreaCustomChargeLevel<>(120, 1.75F, new Color(255, 0, 0)),
                new AphoreaCustomChargeLevel<>(120, 2F, new Color(47, 0, 0)),
                new AphoreaCustomChargeLevel<>(120, 1.75F, new Color(255, 0, 0)),
                new AphoreaCustomChargeLevel<>(100, 1.5F, new Color(255, 128, 0)),
                new AphoreaCustomChargeLevel<>(90, 1.25F, new Color(255, 255, 0)),
                new AphoreaCustomChargeLevel<>(80, 1.0F, new Color(255, 255, 255))
    ...
    public boolean canLevelInteract(Level level, int x, int y, PlayerMob player, InventoryItem item) {
        return !player.isRiding() && !player.isAttacking && !this.isCharging && !player.buffManager.hasBuff(BuffRegistry.getBuff("saberdashcooldown"));
    }
    ...
    public static class SaberAttackHandler extends AphoreaCustomChargeAttackHandler<AphoreaSaberToolItem> {

        public SaberAttackHandler(PlayerMob player, PlayerInventorySlot slot, InventoryItem item, AphoreaSaberToolItem toolItem, int seed, int startX, int startY, AphoreaCustomChargeLevel<AphoreaSaberToolItem>[] chargeLevels) {
        ...
        public float getChargePercent() {
            ...
            float linearPercent = (float)Math.min(this.getTimeSinceStart(), (long)chargeTime) / (float)chargeTime;
    ...
    public static class SaberDashAttackHandler extends MousePositionAttackHandler {
        ...
        public AphoreaSaberToolItem saberItem;
        ...
        public SaberDashAttackHandler(PlayerMob player, PlayerInventorySlot slot, InventoryItem item, AphoreaSaberToolItem saberItem, int chargeTime, Color particleColors, int seed) {
        ...
        public void onEndAttack(boolean bySelf) {
            ...
            if (!this.endedByInteract && chargePercent >= 0.5F) {
                ...
                ActiveBuff buff = new ActiveBuff(BuffRegistry.getBuff("saberdashcooldown"), this.player, 5.0F, null);
    ...
    public static class SaberDashLevelEvent extends MobDashLevelEvent {
        ...
        public void init() {
            ...
            if (this.owner != null) {
                ActiveBuff buff = new ActiveBuff(BuffRegistry.getBuff("saberdashactive"), this.owner, this.animTime, null);
