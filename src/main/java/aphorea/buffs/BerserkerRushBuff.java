...
public class BerserkerRushBuff extends Buff {
    ...
    public void init(ActiveBuff buff, BuffEventSubscriber eventSubscriber) {
        ...
        buff.owner.buffManager.addBuff(new ActiveBuff(BuffRegistry.getBuff("stopbuff"), buff.owner, 1F, null), false);
    ...
    public void onRemoved(ActiveBuff buff) {
        if(buff.owner.isPlayer) {
            ...
            player.buffManager.addBuff(new ActiveBuff(BuffRegistry.getBuff("berserkerrushcooldownbuff"), player, 20.0F, null), false);
