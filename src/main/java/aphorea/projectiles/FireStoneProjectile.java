...
public class FireStoneProjectile extends StoneProjectile {

    int count = 0;

    public static GameTexture texture_2;

    public FireStoneProjectile() {
    }
    ...
    public FireStoneProjectile(Level level, Mob owner, float x, float y, float targetX, float targetY, float speed, int distance, GameDamage damage, int knockback) {
