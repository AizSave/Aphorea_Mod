...
public class FrozenStoneProjectile extends StoneProjectile {

    public FrozenStoneProjectile() {
    }

    public FrozenStoneProjectile(Level level, Mob owner, float x, float y, float targetX, float targetY, float speed, int distance, GameDamage damage, int knockback) {
