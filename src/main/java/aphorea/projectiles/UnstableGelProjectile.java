...
public class UnstableGelProjectile extends Projectile {
    ...
    public UnstableGelProjectile(Level level, Mob owner, float x, float y, float targetX, float targetY, float speed, int distance, GameDamage damage, int knockback) {
        this.setLevel(level);
        this.setOwner(owner);
        this.x = x;
        this.y = y;
    ...
    public Color getParticleColor() {
        return new Color(191, 102, 255);
    }

    @Override
    public Trail getTrail() {
        return new Trail(this, getLevel(), new Color(191, 102, 255), 26, 500, getHeight());
    }
