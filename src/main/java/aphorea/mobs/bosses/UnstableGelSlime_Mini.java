...
public class UnstableGelSlime_Mini extends FlyingHostileMob {
    ...
    public void init() {
        ...
        ActiveBuff buff = new ActiveBuff(BuffRegistry.getBuff("inmortalbuff"), this, 1000, this);
    ...
    public Mob getRandomTarget(Point base, TargetFinderDistance<UnstableGelSlime_Mini> distance) {
    ...
    public void spawnDeathParticles(float knockbackX, float knockbackY) {
        for (int i = 0; i < 4; i++) {
            getLevel().entityManager.addParticle(new FleshParticle(
                    getLevel(), texture == null ? GameTexture.fromFile("mobs/unstablegelslime_mini") : texture,
    ...
    public void handleCollisionHit(Mob target, GameDamage damage, int knockback) {
        ...
        ActiveBuff buff = new ActiveBuff(BuffRegistry.getBuff("stickybuff"), target, 500, this);
